        ...
        <section class="user_profile inner_pages">
          <div class="container">
            <div class="user_profile_info gray-bg padding_4x4_40">
              <div class="upload_user_logo"> <img src="../img/logosite.png" alt="image">
              </div>
            ...
            <div class="col-md-3 col-sm-3">
             ...
             <div class="col-md-8 col-sm-8">
              <div class="profile_wrap">
                <h5 class="uppercase underline">My Artisans Bookings </h5>
                <div class="my_vehicles_list">
                  <ul class="vehicle_listing">
                    ...
                    if($query->rowCount() > 0)
                    {
                      ...
                      {  
                        ...
                        <li>
                          <h4 style="color:red">Booking. &nbsp;<?php echo htmlentities($result->BookingNumber);?></h4>
                          ...
                          <div class="vehicle_title">
                            ...
                            <div style="float: left"><p><b>Email:</b> <?php echo htmlentities($result->Email);?> </p></div>
                          </div>
                  ...
                  <h5 aligne="center" style="color:red">No booking yet</h5>
                  <?php 
                } ?>
              </ul>
            </div>
