...
<head>
  <meta charset="utf-8">
  <title>ArtiSanat|Product Details</title>
...
<body id="body"> 
 ...
 <section id="innerBanner"> 
  <div class="inner-content">
    <h2><span>ABOUT PRODUCT</span><br>We provide antique and sophisticated Leather</h2>
    <div> 
    </div>
  </div> 
</section><!-- #Page Banner -->
      ...
      <section id="clients"  class="wow fadeInUp">
        <div class="container">
          <div class="section-header">
            ...
            <p>The Leather bags, shoes and belts that we sell are a combination of art and emotions. A unique artistic language.</p>
          </div>
          <?php 
                  ...
                  <div class="listing_more_info">
                    <div class="listing_detail_wrap"> 
                      ...
                      <ul class="nav nav-tabs gray-bg" role="tablist">
                        <li role="presentation" class="active"><a href="#vehicle-overview " aria-controls="vehicle-overview" role="tab" style="background-color: #49a3ff;" data-toggle="tab">Leather Overview </a></li>
                      </ul>
        ...
        <div class="similar_cars">
          ...
          <div class="row">
            <?php 
            $bid=$_SESSION['brndid'];
            $sql="SELECT tblvehicles.VehiclesTitle,tblbrands.BrandName,tblvehicles.PricePerDay,tblvehicles.ModelYear,tblvehicles.id,tblvehicles.VehiclesOverview,tblvehicles.Vimage1 from tblvehicles join tblbrands on tblbrands.id=tblvehicles.VehiclesBrand where tblvehicles.VehiclesBrand=:bid";
            $query = $dbh -> prepare($sql);
              ...
              { 
                ...
                <div class="col-md-3 grid_listing">
                  <div class="product-listing-m gray-bg">
                    <div class="product-listing-img"> <a href="cuir_details.php?vhid=<?php echo htmlentities($result->id);?>"><img src="../admin/img/Cuir/<?php echo htmlentities($result->Vimage1);?>" class="img-responsive" style="height: 350px; width: 300px;" alt="image" /> </a>
                    </div>
