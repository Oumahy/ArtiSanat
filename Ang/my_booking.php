    ...
    foreach($results as $result)
      { ?>
        <section class="user_profile inner_pages">
            ...
            <div class="col-md-3 col-sm-3">
             ...
             <div class="col-md-8 col-sm-8">
              <div class="profile_wrap">
                <h5 class="uppercase underline">My Leather Bookings </h5>
                    ...
                    if($query->rowCount() > 0)
                    {
                      ...
                      {  
                        ...
                        <li>
                          ...
                          <div class="vehicle_img"> <a href="cuir_details.php?vhid=<?php echo htmlentities($result->vid);?>"><img src="../admin/img/artisanatimage/<?php echo htmlentities($result->Vimage1);?>" alt="image"></a> </div>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                      <div class="modal-content">
                                        <div class="modal-header">
                                          <h5 class="modal-title" id="exampleModalLongTitle">Mode Payment</h5>
                              ...
                              <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                  ...
                                  <div class="modal-body">
                                    <p style="text-align: center">Your request has not been processed. Or you didn't enter your information correctly. Or the product is out of stock. <br>
                                    For more information<a href="contact.php" class="tooltip-test" title="Tooltip">&nbsp;&nbsp;Contact us</a></p></style>
                                  </div>
                                </div>
                              </div>
                            </div> 
                         ...
                         Not Confirm yet
                          ...
                          <div class="modal fade" id="exampleModalLong" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                              <div class="modal-content">
                                <div class="modal-header">
                                  <h5 class="modal-title" id="exampleModalLongTitle">In the process of treatment</h5>
                                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                  </button>
                                </div>
          ...
          <div class="profile_wrap">
                <h5 class="uppercase underline">My C&P Bookings </h5>
                <div class="my_vehicles_list">
                  <ul class="vehicle_listing">
                    <?php 
                    $useremail=$_SESSION['login'];
                    ...
                    if($query->rowCount() > 0)
                    {
                      ...
                      {  
                        ...
                        <li>
                          <h4 style="color:red">You're Booking. &nbsp;</h4>
                          <div class="vehicle_img"> <a href="T&P_details.php?vhid=<?php echo htmlentities($result->vid);?>"><img src="../admin/img/artisanatimage/<?php echo htmlentities($result->Vimage1);?>" alt="image"></a> </div>
                          <div class="vehicle_title">
    ...
    <div class="container">
      <div class="row">
        ...
        <h3 class="cta-title">You want to contact our team? You are welcome!</h3>
           <p class="cta-text">We are ready to get your questions and offer you better solutions.</p>
        </div>
