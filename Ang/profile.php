...
{ 
  ...
  <head>
    <meta charset="utf-8">
    <title>ArtiSanat| My Profile</title>
  ...
  <body id="body">
    ...
    <section id="innerBanner"> 
      <div class="inner-content">
        <h2><span>My Profile</span><br>Your satisfaction is our inspiration!</h2>
        <div> 
        </div>
      </div> 
    </section><!-- #Page Banner -->
          ...
          <section class="user_profile inner_pages">
            <div class="container">
              <div class="user_profile_info gray-bg padding_4x4_40">
                <div class="upload_user_logo"> <img src="img/artisanat.png" alt="image">
                </div>
                      ...
                      <div class="profile_wrap">
                        ...
                        <form  method="post">
                          <div class="form-group">
                            <label class="control-label">Fbr Date -</label>
