...
<head>
  <meta charset="utf-8">
  <title>ArtiSanat | Search product</title>
...
<body id="body"> 
 ...
 <section id="innerBanner"> 
  <div class="inner-content">
     <h1 style="color: #ffffff; font-size: 35px;">Search Result of keyword<?php echo $_POST['searchdata'];?></h1 ><br> 
     <h5 style="color:aquamarine"> We provide high quality products</h5>
  </div> 
</section><!-- #Page Banner -->
      ...
      <div class="col-md-9 col-md-push-3">
        <div class="result-sorting-wrapper">
          <div class="sorting-count">
            ...
            where tblvehicles.VehiclesTitle=:search || tblbrands.BrandName=:search || tblvehicles.ModelYear=:search";
            ...
            $cnt=$query->rowCount();
            ?>
            <p><span><?php echo htmlentities($cnt);?> Product found </span></p>
          </div>
        </div>
        ...
        if($query->rowCount() > 0)
        {
          ...
          {  
            ...
            <div class="product-listing-m gray-bg" >
              <div class="product-listing-img"><img src="img/all<?php echo htmlentities($result->Vimage1);?>" class="img-responsive" alt="Image" style="width: 380px; height: 250px;" /> </a> 
              </div>
      ...
      <aside class="col-md-3 col-md-pull-9">
        <div class="sidebar_widget">
          <div class="widget_heading">
            <h5> Recently Listed Products</h5>
          </div>
            ...
            <ul>
              ...
              if($query->rowCount() > 0)
              {
                ...
                {  
                  ...
                  <li class="gray-bg">
                    <div class="recent_post_img"> <a href="vehical-details.php?vhid=<?php echo htmlentities($result->id);?>"><img src="img/all/<?php echo htmlentities($result->Vimage1);?>" alt="image"></a> </div>
