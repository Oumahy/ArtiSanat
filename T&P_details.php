...
if(isset($_POST['submit']))
{
  ...
  if($query1->rowCount()==0)
  {
    ...
    $sql="INSERT INTO  tblbooking(userEmail,VehicleId,FromDate,ToDate,Quantity,message,Status,BookingNumber,VehicleType) VALUES(:useremail,:vhid,:fromdate,:todate,:Quantity,:message,:status,:bookingno,:bike)";
   ...
   echo "<script>alert('T&P already booked for these days');</script>"; 
   echo "<script type='text/javascript'> document.location = 'T&P.php'; </script>";
 }
}
...
<body id="body"> 
 ...
 <section id="innerBanner"> 
  <div class="inner-content">
    <h2><span>À PROPOS DU T&P</span><br>Nous fournissons des T&P de haute qualité et bien entretenus </h2>
    <div> 
    </div>
  </div> 
</section><!-- #Page Banner -->
          ...
          <section class="listing-detail">
            <div class="container">
              <div class="listing_detail_head row">
                <div class="col-md-9">
                  <h2> <?php echo htmlentities($result->BikeTitle);?>Produit</h2>
                </div>
                <div class="col-md-3">
                  ...
                  <div class="listing_more_info">
                    <div class="listing_detail_wrap"> 
                      ...
                      <ul class="nav nav-tabs gray-bg" role="tablist">
                        <li role="presentation" class="active"><a href="#vehicle-overview " aria-controls="vehicle-overview" role="tab" style="background-color: #49a3ff;" data-toggle="tab">Présentation du T&P</a></li>
              ...
              { 
                ...
                <div class="col-md-3 grid_listing">
                  <div class="product-listing-m gray-bg">
                    <div class="product-listing-img"> <a href="T&P_details.php?vhid=<?php echo htmlentities($result->id);?>"><img src="admin/img/bikeimages/<?php echo htmlentities($result->Vimage1);?>" class="img-responsive" style="height: 200px; width: 360px;" alt="image" /> </a>
                    </div>
