...
if(isset($_GET['del']))
{
  ...
  $query -> execute();
  echo "<script>alert('category deleted succeffully.');</script>"; 
                ...
                <form class="forms-sample" method="post" enctype="multipart/form-data" class="form-horizontal">
                  <div class="row ">
                    <div class="form-group col-md-6">
                      ...
                      <input type="text" name="brandname" class="form-control" value="" id="brandname" placeholder="Enter category" required>
                    </div>
                  </div>
                      ...
                      {     
                        ...
                        <tr>
                          ...
                          <td class=" text-center"><a href="#"  class=" edit_data4" id="<?php echo  ($result->id); ?>" title="click to edit"><i class="mdi mdi-pencil-box-outline" aria-hidden="true"></i></a>&nbsp;&nbsp;
                            <a href="category.php?del=<?php echo $result->id;?>" onclick="return confirm('Do you want to delete');"><i class="mdi mdi-delete"></i></i></a></td>
