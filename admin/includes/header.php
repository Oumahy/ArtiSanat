    ...
    if($query->rowCount() > 0)
    {
      ...
      {  
        ...
        <a class="navbar-brand brand-logo-mini" href="dashboard.php"><img style="height: 30px; width: 30px;" src="assets/img/avatars/avatar15.jpg" alt="logo" /></a>
          ...
          <a class="navbar-brand brand-logo " href="dashboard.php"><img class="img-avatar" style="height: 60px; width: 60px;" src="../img/logosite.png" alt=""></a>
        <a class="navbar-brand brand-logo-mini" href="dashboard.php"><img style="height: 30px; width: 30px;" src="../img/logosite.png" alt="logo" /></a>
          <?php 
        } ?>
        <?php
      }
      ...
      <li class="nav-item nav-profile dropdown">
        ...
        <div class="dropdown-menu navbar-dropdown" aria-labelledby="profileDropdown">
          <a class="dropdown-item" href="profile.php">
            ...
            <a class="dropdown-item" href="change_password.php"><i class="mdi mdi-settings mr-2 text-success"></i>réglages </a>
            <div class="dropdown-divider"></div>
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="notificationDropdown">
              <h6 class="p-3 mb-0">You have <?php echo htmlentities($totalnewbooking);?> nouvelle notification</h6>
              <div class="dropdown-divider"></div>
              <?php
                ...
                {              
                  ...
                  <a class="dropdown-item preview-item">
                    ...
                    <div class="preview-item-content d-flex align-items-start flex-column justify-content-center">
                      ...
                      <p class="text-gray ellipsis mb-0">réservé</p>
                    </div>
                  </a>
                  <?php 
                }
              } else {?>
                <a class="dropdown-item" href="#">Aucune nouvelle réservation reçue</a>
              <?php } ?>
              <div class="dropdown-divider"></div>
              <h6 class="p-3 mb-0 text-center"> <a href="new_bookings.php">Voir toutes les nouvelles réservations</a></h6>
            </div>
          </li>
