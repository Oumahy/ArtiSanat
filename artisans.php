...
<head>
  <meta charset="utf-8">
  <title>ArtiSanat| réserver un artisans</title>
  ...
  <link id="ekka-css" rel="stylesheet" href="css/style3.css"> 
...
<body id="body"> 
 ...
 <section id="innerBanner"> 
  <div class="inner-content">
    <h2><span>Artisans</span><br>Une élite d'artisans à l'écoute.</h2>
    <div> 
    </div>
  </div> 
</section><!-- #Page Banner -->
                    ...
                    <div class="media-body">
                      ...
                      <ul class="list-unstyled">
                        ...
                        <li class="d-flex mb-1">
                          ...
                          <span>(+212) <?php echo htmlentities($result->Phone);?></span>
                        </li>
                        <li class="d-flex mb-1"><?php echo htmlentities($result->PricePerDay);?> Dh par jours</li>
                        <li class="d-flex mb-1"><?php echo htmlentities($result->Experience);?> Expérience</li>
                        <li>
                         <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modal-add-contact">Réserver</button>
                       </li>
                     </ul>
                   </div>
                 </a>
                  ...
                  {     
                      ...
                      <div class="profile-content-left px-4">
                        <div class="text-center widget-profile px-0 border-0">
                          ...
                          <div class="card-body">
                            ...
                            <a class="btn btn-primary btn-pill my-4" href="#">Abonne</a>
                          </div>
                        </div>
                    ...
                    <div class="col-md-6">
                      <div class="contact-info px-4">
                        ...
                        <p class="text-dark font-weight-medium pt-4 mb-2">Addresse email </p>
                        <p>
                        ...
                        <p class="text-dark font-weight-medium pt-4 mb-2">Tele</p>
                        <p>+212 <?php echo htmlentities($result2->Phone);?></p>
                        <p class="text-dark font-weight-medium pt-4 mb-2">Experience</p>
                        <p><?php echo htmlentities($result2->Experience);?></p>
                        <p class="text-dark font-weight-medium pt-4 mb-2">Addresse</p>
            ...
            <div class="modal-content">
              <form method="post">
                <div class="modal-header px-4">
                  <h5 class="modal-title" id="exampleModalCenterTitle">Hire Artisans</h5>
                </div>
