...
<head>
  <meta charset="utf-8">
  <title>CEasyRental | Recherche</title>
...
<body id="body"> 
 ...
 <section id="innerBanner"> 
  <div class="inner-content">
    <h2><span > <h1 style="color: #ffffff; font-size: 35px;">Résultat de la recherche du mot-clé"<?php echo $_POST['searchdata'];?>"</h1></span><br>We provide high quality cars!</h2>
  </div> 
</section><!-- #Page Banner -->
      ...
      <div class="col-md-9 col-md-push-3">
        <div class="result-sorting-wrapper">
          <div class="sorting-count">
            ...
            $cnt=$query->rowCount();
            ?>
            <p><span><?php echo htmlentities($cnt);?> Annonces trouvées lors de la recherche</span></p>
          </div>
        </div>
